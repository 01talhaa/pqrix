...
export function ProjectsGrid({ initialProjects, initialServices }: { initialProjects: Project[], initialServices: Service[] }) {
  const [selectedService, setSelectedService] = useState<string>("all")
  const [projects, setProjects] = useState<Project[]>(initialProjects)

  const filteredProjects = selectedService === "all" 
    ? projects 
    : projects.filter(p => p.serviceCategory === selectedService)
